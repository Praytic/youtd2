var Godot = (() => {
  ...
  return (
    function (Godot) {
      ...
      var ERRNO_CODES = {};
      var GodotFS = {
        _idbfs: false, _syncing: false, _mount_points: [], is_persistent: function () {
      ...
      var GodotDisplayCursor = {
        shape: "auto", visible: true, cursors: {}, set_style: function (style) {
      ...
      var GodotJSWrapper = {
        proxies: null, MyProxy: function (val) {
        ...
        blitTexture: (gl, texture) => {
          if (GodotWebXR.shaderProgram === null) {
            ...
            GodotWebXR.programInfo = {
              ...
              attribLocations: {vertexPosition: gl.getAttribLocation(GodotWebXR.shaderProgram, "aVertexPosition")},
              uniformLocations: {uSampler: gl.getUniformLocation(GodotWebXR.shaderProgram, "uSampler")}
            };
