...
func item_init():
	...
	presence_tower_bt.set_buff_icon("res://resources/Icons/GenericIcons/poison_gas.tres")
	...
	presence_creep_bt.set_buff_icon("res://resources/Icons/GenericIcons/poison_gas.tres")
