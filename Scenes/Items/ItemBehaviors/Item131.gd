...
func item_init():
	...
	aura_bt.set_buff_icon("res://Resources/Textures/Buffs/letter_omega.tres")
...
func on_kill(_event: Event):
	...
	var effect: int = Effect.create_scaled("SpiritTouchTarget.mdl", tower.get_position_wc3(), 0.0, 5)
