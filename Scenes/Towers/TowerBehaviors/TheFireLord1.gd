...
func tower_init():
	...
	liquid_fire_bt.set_buff_icon("res://Resources/Textures/GenericIcons/fire_dash.tres")
	...
	hellfire_bt.set_buff_icon("res://Resources/Textures/GenericIcons/amber_mosquito.tres")
