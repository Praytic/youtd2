...
func get_ability_ranges() -> Array[RangeData]:
	return [RangeData.new("Impenetrable Darkness", 850, TargetType.new(TargetType.CREEPS))]
...
func tower_init():
	...
	darkness_bt.set_buff_icon("res://Resources/Textures/Buffs/running_man_burning.tres")
	...
	maledict_bt.set_buff_icon("res://Resources/Textures/Buffs/running_man_burning.tres")
	...
	demonic_mana_bt.set_buff_icon("res://Resources/Textures/Buffs/orb_sparkly.tres")
	demonic_mana_bt.set_buff_tooltip("Demonic Mana\nIcreases mana regeneration.")

	aura_bt = BuffType.create_aura_effect_type("aura_bt", true, self)
	aura_bt.set_buff_icon("res://Resources/Textures/Buffs/fireball.tres")
