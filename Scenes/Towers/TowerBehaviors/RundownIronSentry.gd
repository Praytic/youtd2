...
func get_ability_ranges() -> Array[RangeData]:
	return [RangeData.new("Alert", 500, TargetType.new(TargetType.TOWERS))]
...
func tower_init():
	...
	alert_bt.set_buff_icon("res://Resources/Textures/GenericIcons/barbute.tres")
	...
	trespasser_bt.set_buff_icon("res://Resources/Textures/GenericIcons/semi_closed_eye.tres")
