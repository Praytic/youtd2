...
func tower_init():
	...
	slow_bt.set_buff_icon("res://Resources/Textures/GenericIcons/ophiucus.tres")
	slow_bt.set_buff_tooltip("Overload\nReduces movement speed.")

	surge_bt = BuffType.new("surge_bt", 5, 0, true, self)
	surge_bt.set_buff_icon("res://Resources/Textures/GenericIcons/shiny_omega.tres")
	surge_bt.add_periodic_event(surge_bt_periodic, 0.4)
	surge_bt.set_buff_tooltip("Magnetic Surge\nDeals damage over time.")

	aura_bt = BuffType.create_aura_effect_type("aura_bt", false, self)
	aura_bt.set_buff_icon("res://Resources/Textures/GenericIcons/moebius_trefoil.tres")
