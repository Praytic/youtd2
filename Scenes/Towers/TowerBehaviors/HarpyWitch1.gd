...
func get_ability_ranges() -> Array[RangeData]:
	return [RangeData.new("Sparks", 500, TargetType.new(TargetType.TOWERS))]
...
func tower_init():
	...
	sparks_bt.set_buff_icon("res://Resources/Textures/Buffs/electricity.tres")
	...
	twister_bt.set_buff_icon("res://Resources/Textures/Buffs/letter_s_lying_down.tres")
