...
#	Real buff, adding the damage bonus.
	...
	lastline_real_bt.set_buff_icon("res://Resources/Textures/GenericIcons/semi_closed_eye.tres")
	...
	wewillnotfall_bt.set_buff_icon("res://Resources/Textures/GenericIcons/shiny_omega.tres")
