...
func tower_init():
	...
	morale_bt.set_buff_icon("res://Resources/Textures/Buffs/flexing_arm.tres")
...
func on_damage(event: Event):
	...
	var effect: int = Effect.create_scaled("ImpaleTargetDust.mdl", Vector3(creep.get_x(), creep.get_y(), 0.0), 0, 5)
