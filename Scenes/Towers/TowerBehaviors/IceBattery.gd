...
func get_autocast_description() -> String:
	...
	text += "The tower attacks creeps in a range of 1200 every 0.2 seconds till all mana is gone. Each attack (or try to attack) costs 10 mana, deals %s damage and applies [color=GOLD]Frost[/color].\n" % [projectile_damage]
	text += " \n"
