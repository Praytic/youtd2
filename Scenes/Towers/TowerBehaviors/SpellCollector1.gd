...
func tower_init():
	...
	spell_gathering_bt.set_buff_icon("res://Resources/Textures/Buffs/orb_empty.tres")
	...
	missile_stacks_bt.set_buff_icon("res://Resources/Textures/Buffs/letter_omega_shiny.tres")
