...
func tower_init():
	...
	speedcast_bt.set_buff_icon("res://Resources/Textures/GenericIcons/holy_grail.tres")
	...
	magic_boost_bt.set_buff_icon("res://Resources/Textures/GenericIcons/gold_bar.tres")
