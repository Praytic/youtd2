...
func tower_init():
	...
	fighter_totem_bt.set_buff_icon("res://Resources/Textures/Buffs/cup_with_wings.tres")
	...
	shamanic_totem_bt.set_buff_icon("res://Resources/Textures/Buffs/skull.tres")
	shamanic_totem_bt.set_buff_tooltip("Shamanic Totem\nIncreases spell damage.")

	demonic_fire_bt = BuffType.new("demonic_fire_bt", 5, 0.2, false, self)
	demonic_fire_bt.set_buff_icon("res://Resources/Textures/Buffs/mask_occult.tres")
