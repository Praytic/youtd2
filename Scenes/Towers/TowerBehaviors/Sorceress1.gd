...
func tower_init():
	...
	sunder_bt.set_buff_icon("res://Resources/Textures/GenericIcons/armor_vest.tres")
	...
	spell_vuln_bt.set_buff_icon("res://Resources/Textures/GenericIcons/alligator_clip.tres")
