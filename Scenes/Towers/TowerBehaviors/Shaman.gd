...
func tower_init():
	...
	bloodlust_bt.set_buff_icon("res://Resources/Textures/GenericIcons/moebius_trefoil.tres")
	...
	autocast.icon = "res://Resources/Textures/ItemIcons/voodoo_mask_red.tres"
	autocast.caster_art = ""
