...
func tower_init():
	...
	aura_bt.set_buff_icon("res://Resources/Textures/Buffs/hammer_swing.tres")
	...
	intense_heat_bt.set_buff_icon("res://Resources/Textures/Buffs/running_man_burning.tres")
