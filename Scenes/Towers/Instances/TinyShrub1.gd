...
func _ready():
	...
	specials_modifier.add_modification(Modification.Type.MOD_ATTACK_CRIT_CHANCE, _stats.crit_chance, _stats.crit_chance_add)
	specials_modifier.add_modification(Modification.Type.MOD_ATTACK_CRIT_DAMAGE, _stats.crit_damage, _stats.crit_damage_add)
