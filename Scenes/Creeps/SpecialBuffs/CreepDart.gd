...
func _init(parent: Node):
	...
	creep_darting.set_buff_icon("res://Resources/Textures/GenericIcons/fire_dash.tres")
	...
	creep_tired.set_buff_icon("res://Resources/Textures/GenericIcons/animal_skull.tres")
