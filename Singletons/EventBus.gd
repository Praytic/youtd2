...
signal player_requested_to_select_point_for_autocast(autocast: Autocast)
signal player_requested_to_select_target_for_autocast(autocast: Autocast)
signal player_requested_to_clear_combatlog()
signal player_requested_toggle_for_autocast(autocast: Autocast)
