...
signal player_shift_right_clicked_item_in_tower_inventory(item: Item)
signal player_right_clicked_item_in_item_stash(item: Item)
signal player_right_clicked_item_in_tower_inventory(item: Item)
signal player_clicked_in_tower_inventory(tower: Tower, clicked_index: int)
