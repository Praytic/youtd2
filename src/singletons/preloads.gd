...
const item_button_scene: PackedScene = preload("res://src/ui/hud/buttons/item_button.tscn")
const tower_button_scene: PackedScene = preload("res://src/ui/hud/buttons/tower_button.tscn")
...
const autocast_button_scene: PackedScene = preload("res://src/ui/hud/buttons/autocast_button.tscn")
...
const empty_slot_button_scene: PackedScene = preload("res://src/ui/hud/buttons/empty_unit_button.tscn")
...
const buff_display_scene: PackedScene = preload("res://src/ui/hud/unit_menu/buff_display.tscn")
const fallback_buff_icon: Texture = preload("res://resources/icons/generic_icons/egg.tres")
const builder_button_scene: PackedScene = preload("res://src/ui/hud/buttons/builder_button.tscn")
const ability_button_scene: PackedScene = preload("res://src/ui/hud/buttons/ability_button.tscn")
const inventory_slot_button_scene: PackedScene = preload("res://src/ui/hud/buttons/inventory_slot_button.tscn")
