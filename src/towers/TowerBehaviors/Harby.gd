...
func get_ability_info_list() -> Array[AbilityInfo]:
	...
	arcane_orb.icon = "res://resources/icons/tower_icons/DarkBattery.tres"
...
func get_aura_types() -> Array[AuraType]:
	...
	aura.icon = "res://resources/icons/tower_icons/AstralRift.tres"
...
func arcane_mana_replenish(target: Tower):
	var effect: int = Effect.create_colored("ReplenishHealthCasterOverhead.mdl", Vector3(target.get_x(), target.get_y(), 80), 0.0, 5, Color8(100, 100, 255, 255))
