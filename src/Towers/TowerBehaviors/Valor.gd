...
#	Real buff, adding the damage bonus.
	...
	lastline_real_bt.set_buff_icon("res://resources/Icons/GenericIcons/semi_closed_eye.tres")
	...
	wewillnotfall_bt.set_buff_icon("res://resources/Icons/GenericIcons/shiny_omega.tres")
	...
	valor_light_bt.set_buff_icon("res://resources/Icons/GenericIcons/foot_trip.tres")
