...
static func make_item_drop(item: Item, drop_pos: Vector3):
	...
	var item_drop_scene_map: Dictionary = {
		"res://src/items/CommonItem.tscn": preload("res://src/items/CommonItem.tscn"),
		"res://src/items/UncommonItem.tscn": preload("res://src/items/UncommonItem.tscn"),
		"res://src/items/RareItem.tscn": preload("res://src/items/RareItem.tscn"),
		"res://src/items/UniqueItem.tscn": preload("res://src/items/UniqueItem.tscn"),
		"res://src/items/RedOil.tscn": preload("res://src/items/RedOil.tscn"),
	}
	...
	if ItemProperties.get_is_oil(item_id):
		item_drop_scene_path = "res://src/items/RedOil.tscn"
	else:
